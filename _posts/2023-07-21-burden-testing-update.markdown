...
### Job hangs at group & aggregation step

When I ran the algorithm with these values, the job ran successfully until the group & aggregation step:
...
When I ran the The technical problem that was blocking me last time



HGDP
Turned out to be variant annotations, not 
