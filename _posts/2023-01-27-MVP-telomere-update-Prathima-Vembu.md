...
- Tool used for study - [Telseq](https://github.com/zd1/telseq)
...
* Dockerize Telseq : Use the [docker image](https://hub.docker.com/r/jweinstk/telseq) provided by authors or create a new image. The main changes in the new dockerfile are changes in the version of samtools and telseq and has been pushed into dockerhub. <br>
**Note** - The current Telseq run was perfomed using the docekr image generated by the authors <br>
...
* Subsequently the process will be integrated into Trellis for large scale deployment 
